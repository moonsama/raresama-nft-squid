...
export type SetExtension0Function = ([_extension: string] & {_extension: string})
...
export const functions = {
  ...
  ,
  "setExtension(string)": {
    sighash: abi.getSighash("setExtension(string)"),
    decode(input: string): SetExtension0Function {
      return decodeFunction(input)
    }
  }
  ,
