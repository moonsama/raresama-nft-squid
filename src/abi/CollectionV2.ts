...
export type DefaultSecondarySaleFeeSet0Event = ([feeRecipient: string, feeValueBps: ethers.BigNumber] & {feeRecipient: string, feeValueBps: ethers.BigNumber})
...
export type TokenSecondarySaleFeeSet0Event = ([tokenId: ethers.BigNumber, feeRecipient: string, feeValueBps: ethers.BigNumber] & {tokenId: ethers.BigNumber, feeRecipient: string, feeValueBps: ethers.BigNumber})
...
export const events = {
  ...
  ,
  "DefaultSecondarySaleFeeSet(address,uint256)": {
    topic: abi.getEventTopic("DefaultSecondarySaleFeeSet(address,uint256)"),
    decode(data: EvmLog): DefaultSecondarySaleFeeSet0Event {
      return decodeEvent("DefaultSecondarySaleFeeSet(address,uint256)", data)
    }
  }
  ,
  "Lock(uint256)": {
  ...
  ,
  "TokenSecondarySaleFeeSet(uint256,address,uint256)": {
    topic: abi.getEventTopic("TokenSecondarySaleFeeSet(uint256,address,uint256)"),
    decode(data: EvmLog): TokenSecondarySaleFeeSet0Event {
      return decodeEvent("TokenSecondarySaleFeeSet(uint256,address,uint256)", data)
    }
  }
  ,
...
export type Initialize0Function = ([addresses: Array<string>, name: string, symbol: string, _decimals: number, _contractURI: string, _defaultTokenURI: string, _proxyRegistryAddress: string] & {addresses: Array<string>, name: string, symbol: string, _decimals: number, _contractURI: string, _defaultTokenURI: string, _proxyRegistryAddress: string})
...
export type MintWithRoyalty0Function = ([to: string, _customTokenURI: string, _feeRecipient: string, _feeValueBps: ethers.BigNumber] & {to: string, _customTokenURI: string, _feeRecipient: string, _feeValueBps: ethers.BigNumber})
...
export type SetCustomTransformationTokenURI0Function = ([_id: ethers.BigNumber, _customTransformationTokenURIBase: string] & {_id: ethers.BigNumber, _customTransformationTokenURIBase: string})

export type SetDefaultRoyaltyFee0Function = ([_feeRecipient: string, _feeValueBps: ethers.BigNumber] & {_feeRecipient: string, _feeValueBps: ethers.BigNumber})
...
export type SetExtensionTokenURI0Function = ([_extension: string] & {_extension: string})

export type SetExtensionTransformationTokenURI0Function = ([_extension: string] & {_extension: string})
...
export type SetGlobalTokenURIBase0Function = ([_globalTokenURIBase: string] & {_globalTokenURIBase: string})

export type SetGlobalTransformationTokenURIBase0Function = ([_globalTransformationTokenURIBase: string] & {_globalTransformationTokenURIBase: string})

export type SetProxyRegistryAddress0Function = ([_proxyRegistryAddress: string] & {_proxyRegistryAddress: string})

export type SetTokenRoyaltyFee0Function = ([_tokenId: ethers.BigNumber, _feeRecipient: string, _feeValueBps: ethers.BigNumber] & {_tokenId: ethers.BigNumber, _feeRecipient: string, _feeValueBps: ethers.BigNumber})
...
export const functions = {
  ...
  ,
  "initialize(address[5],string,string,uint8,string,string,address)": {
    sighash: abi.getSighash("initialize(address[5],string,string,uint8,string,string,address)"),
  ...
  ,
  "mintWithRoyalty(address,string,address,uint256)": {
    sighash: abi.getSighash("mintWithRoyalty(address,string,address,uint256)"),
    decode(input: string): MintWithRoyalty0Function {
      return decodeFunction(input)
    }
  }
  ,
  ...
  ,
  "setCustomTransformationTokenURI(uint256,string)": {
    sighash: abi.getSighash("setCustomTransformationTokenURI(uint256,string)"),
    decode(input: string): SetCustomTransformationTokenURI0Function {
      return decodeFunction(input)
    }
  }
  ,
  "setDefaultRoyaltyFee(address,uint256)": {
    sighash: abi.getSighash("setDefaultRoyaltyFee(address,uint256)"),
    decode(input: string): SetDefaultRoyaltyFee0Function {
      return decodeFunction(input)
    }
  }
  ,
  ...
  ,
  "setExtensionTokenURI(string)": {
    sighash: abi.getSighash("setExtensionTokenURI(string)"),
    decode(input: string): SetExtensionTokenURI0Function {
      return decodeFunction(input)
    }
  }
  ,
  "setExtensionTransformationTokenURI(string)": {
    sighash: abi.getSighash("setExtensionTransformationTokenURI(string)"),
    decode(input: string): SetExtensionTransformationTokenURI0Function {
      return decodeFunction(input)
    }
  }
  ,
  ...
  ,
  "setGlobalTokenURIBase(string)": {
    sighash: abi.getSighash("setGlobalTokenURIBase(string)"),
    decode(input: string): SetGlobalTokenURIBase0Function {
      return decodeFunction(input)
    }
  }
  ,
  "setGlobalTransformationTokenURIBase(string)": {
    sighash: abi.getSighash("setGlobalTransformationTokenURIBase(string)"),
    decode(input: string): SetGlobalTransformationTokenURIBase0Function {
      return decodeFunction(input)
    }
  }
  ,
  ...
  ,
  "setTokenRoyaltyFee(uint256,address,uint256)": {
    sighash: abi.getSighash("setTokenRoyaltyFee(uint256,address,uint256)"),
    decode(input: string): SetTokenRoyaltyFee0Function {
      return decodeFunction(input)
    }
  }
  ,
...
export class Contract  {
  ...
  async MANAGER_ROLE(): Promise<string> {
    return this.call("MANAGER_ROLE", [])
  }
  ...
  async globalTokenURIBase(): Promise<string> {
    return this.call("globalTokenURIBase", [])
  }

  async globalTransformationTokenURIBase(): Promise<string> {
    return this.call("globalTransformationTokenURIBase", [])
  }
  ...
  async secondarySaleFee(_tokenId: ethers.BigNumber): Promise<[string, ethers.BigNumber]> {
    return this.call("secondarySaleFee", [_tokenId])
  }
  ...
  async transformationURI(tokenId: ethers.BigNumber): Promise<string> {
    return this.call("transformationURI", [tokenId])
  }
...
function getJsonAbi(): any {
  return [
    ...
    },
    {
      ...
      "name": "DefaultSecondarySaleFeeSet",
      "type": "event"
    },
    {
      "anonymous": false,
    ...
    {
      "inputs": [],
      "name": "globalTransformationTokenURIBase",
      "outputs": [
        {
          "internalType": "string",
          "name": "",
    ...
    },
    {
      "inputs": [
        ...
        {
          "internalType": "string",
          "name": "_customTransformationTokenURIBase",
          "type": "string"
        }
      ],
      "name": "setCustomTransformationTokenURI",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
    ...
    },
    {
      ...
      "name": "setExtensionTransformationTokenURI",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
    ...
    },
    {
      "inputs": [
        {
          "internalType": "string",
          "name": "_globalTokenURIBase",
          "type": "string"
        }
      ],
      "name": "setGlobalTokenURIBase",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
    {
      "inputs": [
        {
          "internalType": "string",
          "name": "_globalTransformationTokenURIBase",
          "type": "string"
        }
      ],
      "name": "setGlobalTransformationTokenURIBase",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
